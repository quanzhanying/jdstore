...
#   Product.create!(title: "经典著作#{i}", description: "这本书主要描述的是：這是作者的第 #{i} 本书", price: rand(19..59), quantity: rand(5..15), image: open('https://upload.wikimedia.org/wikipedia/commons/thumb/2/2b/Melk_-_Abbey_-_Library.jpg/1200px-Melk_-_Abbey_-_Library.jpg'))
# end
# puts "随机创建二十个测试数据."
#
#
